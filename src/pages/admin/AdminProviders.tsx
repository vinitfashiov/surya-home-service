            ...
            <tbody>
              {providers.map((p) => (
                <tr key={p.id} className="border-b last:border-0 hover:bg-muted/30">
                  <td className="p-4 font-medium text-foreground">{p.companyName}</td>
                  <td className="p-4 text-foreground">{p.ownerName}</td>
                  <td className="p-4 text-muted-foreground">{p.email}</td>
                  <td className="p-4 text-foreground">{p.serviceCount}</td>
                  <td className="p-4">
