...
import { Search, Star, ArrowRight, Scissors, Zap, Droplets, SprayCan, Wrench, Paintbrush, Bug, Hammer, MapPin, Clock, Shield, ChevronRight } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { categories, services } from '@/lib/mock-data';
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="block bg-card rounded-xl p-5 shadow-card border hover:shadow-card-hover transition-shadow group"
                  >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {topServices.map((service, i) => (
              ...
              >
                <Link
                  to={`/book/${service.id}`}
                  className="block bg-card rounded-xl shadow-card border overflow-hidden hover:shadow-card-hover transition-shadow"
                >
                  ...
                  <div className="p-5">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-0.5">{service.providerName}</p>
                      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-primary rounded-2xl p-10 md:p-16 text-center">
            ...
            <p className="text-primary-foreground/80 mt-3 max-w-md mx-auto">
              Join thousands of professionals and grow your business with ServisGo.
            </p>
